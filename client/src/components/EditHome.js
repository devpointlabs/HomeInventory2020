...
class EditHome extends React.Component {
  ...
  handleSubmit = (props) => {
    ...
    axios
      .put(
        `/api/homes/${this.props.location.home}/?address=${address}&zip_code=${zip_code}&square_footage=${square_footage}&lot_size=${lot_size}&purchase_date=${purchase_date}&purchase_price=${purchase_price}`,
        data
      )
      .then((res) => {
        console.log(res);
  ...
  render() {
    ...
    return (
      <>
        <StyledBackground>
          <StyledHeader>Edit House Information</StyledHeader>
